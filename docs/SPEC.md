...
15. Popup refinements: immediate tag-mutation saves (coalesced PATCHes via a tested pure serializer), revert of auto-bookmark-on-open (the "Bookmark this page" CTA returns; opening the popup mutates nothing), header links out to the site (§6).
